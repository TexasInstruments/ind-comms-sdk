...
const includes_freertos_r5f_evm = {
    common: [
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethernetip_adapter_demo/deviceProfiles/generic",
...
const libs_freertos_r5f_evm = {
    common: [
        ...
        "ethernetip_adapter_mii_icss_fwhal.am243x.r5f.ti-arm-clang.${ConfigName}.lib",
        ...
        "ethernetipadapter_mii.am243x-evm.r5f.ti-arm-clang.release.lib",
    ],
};
...
const libs_freertos_r5f_lp = {
    common: [
        ...
        "ethernetip_adapter_lwip_contrib.am243x.r5f.ti-arm-clang.${ConfigName}.lib",
        "ethernetip_adapter_lwip_freertos.am243x.r5f.ti-arm-clang.${ConfigName}.lib",
        "ethernetipadapter_mii.am243x-lp.r5f.ti-arm-clang.release.lib",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "ethernetip_adapter_generic_io_mii_demo";
