...
const includes_freertos_r5f_lp = {
    common: [
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethernetip_adapter_demo/config/board/am261x-lp",
...
const libs_freertos_r5f_lp = {
    ...
    "icss_timesync.am261x.r5f.ti-arm-clang.${ConfigName}.lib",
    "ethernetip_adapter_mii_icss_fwhal.am261x.r5f.ti-arm-clang.${ConfigName}.lib",
    "ethernetip_adapter_lwip_contrib.am261x.r5f.ti-arm-clang.${ConfigName}.lib",
    "ethernetip_adapter_lwip_freertos.am261x.r5f.ti-arm-clang.${ConfigName}.lib",
    "ethernetipadapter_mii.am261x.r5f.ti-arm-clang.release.lib",
    ],
};
...
const defines_r5f_lp = {
    common: [
        ...
        "EIP_QUICK_CONNECT=0",
        "CPU_LOAD_MONITOR=0",
        "_DEBUG_USE_CUSTOM_MAC_ADDRESS",
        "_WORKAROUND_PRUICSS_FREQ_225MHZ"
    ],
};
