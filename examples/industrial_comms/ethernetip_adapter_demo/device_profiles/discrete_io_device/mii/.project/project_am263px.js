...
const filedirs_lp = {
    common: [
        ...
        "../../../../../..", /* Example base */
        "../../../../../../board/am263px-lp/freertos/drivers",
        "../../../../../../board/am263px-lp/freertos/drivers/eeprom",
        "../../../../../../board/am263px-lp/freertos/drivers/ethphy",
        "../../../../../../board/am263px-lp/freertos/drivers/flash",
        "../../../../../../board/am263px-lp/freertos/drivers/led",
        "../../../../../../board/am263px-lp/freertos/drivers/pru_icss",
        "../../../../../../device_profiles",
...
const libdirs_freertos = {
    common: [
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/mcu_plus_sdk/source/networking/icss_emac/lib",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/mcu_plus_sdk/source/networking/icss_timesync/lib",
...
const includes_freertos_r5f_lp = {
    common: [
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethernetip_adapter_demo/board/am263px-lp/freertos",
...
const libs_freertos_r5f_lp = {
    ...
    "icss_timesync.am263px.r5f.ti-arm-clang.${ConfigName}.lib",
    "ethernetip_adapter_mii_icss_fwhal.am263px.r5f.ti-arm-clang.${ConfigName}.lib",
    "ethernetip_adapter_lwip_contrib.am263px.r5f.ti-arm-clang.${ConfigName}.lib",
    "ethernetip_adapter_lwip_freertos.am263px.r5f.ti-arm-clang.${ConfigName}.lib",
    "ethernetipadapter_mii.am263px.r5f.ti-arm-clang.release.lib",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "ethernetip_adapter_discrete_io_device_mii_demo";
