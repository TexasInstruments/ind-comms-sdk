...
const filedirs_lp = {
    common: [
        ...
        "../../../../../common/board/am261x-lp/freertos",
        "../../../../../common/os",
        "../../../../../common/os/freertos",
        "../../../../../../nvm",
        "../../../../../../custom_phy/src",
...
const includes_freertos_r5f_lp = {
    common: [
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/common/board/am261x-lp",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/common/board/am261x-lp/freertos",
...
const libs_freertos_r5f_lp = {
    common: [
        ...
        "ethercat_subdevice.am261x_lp.r5f.ti-arm-clang.release.lib",
        "ethercat_subdevice_bkhf_ssc.am261x_lp.r5f.ti-arm-clang.release.lib",
