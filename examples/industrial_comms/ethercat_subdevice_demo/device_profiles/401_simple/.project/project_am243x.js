...
const filedirs_evm = {
    common: [
        ...
        "../../..",   /* Example base */
        "../../../../../common",
        "../../../../../common/board/am243x-evm",
        "../../../../../common/board/am243x-evm/freertos",
        "../../../../../common/os",
        "../../../../../common/os/freertos",
        "../../../../../../custom_phy/src",
        "../../../../../../custom_phy/inc",
...
const filedirs_lp = {
    common: [
        ...
        "../../..",   /* Example base */
        "../../../../../common",
        "../../../../../common/board/am243x-lp",
        "../../../../../common/board/am243x-lp/freertos",
        "../../../../../common/os",
        "../../../../../common/os/freertos",
        "../../../../../../nvm",
        "../../../../../../custom_phy/src",
...
const includes_freertos_r5f_evm = {
    common: [
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/device_profiles/401_simple",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/common",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/common/os",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/common/os/freertos",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/common/board/am243x-evm",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/common/board/am243x-evm/freertos",
...
const includes_freertos_r5f_lp = {
    common: [
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/common/os",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/common/os/freertos",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/common/board/am243x-lp",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/common/board/am243x-lp/freertos",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/custom_phy/inc",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/nvm/app/inc",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/nvm/drv/inc",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/source/industrial_comms/ethercat_slave/stack/inc",
...
const libs_freertos_r5f_evm = {
    common: [
        ...
        "ethercat_subdevice.am243x_evm.r5f.ti-arm-clang.release.lib",
        "ethercat_subdevice_bkhf_ssc.am243x_evm.r5f.ti-arm-clang.release.lib",
...
const readmeDoxygenPageTag = "EXAMPLES_INDUSTRIAL_COMMS_ETHERCAT_SUBDEVICE_DEMOS";
...
function getComponentProperty() {
    ...
    property.name = "ethercat_subdevice_simple_demo";
