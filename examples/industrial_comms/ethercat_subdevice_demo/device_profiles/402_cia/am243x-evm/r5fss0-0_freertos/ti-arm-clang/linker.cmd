...
__SVC_STACK_SIZE = 512; /* This is the size of stack when R5 is in SVC mode */
__ABORT_STACK_SIZE = 512;  /* This is the size of stack when R5 is in ABORT mode */
__UNDEFINED_STACK_SIZE = 512;  /* This is the size of stack when R5 is in UNDEF mode */
...
MEMORY
{
    ...
    MSRAM   : ORIGIN = 0x70100000 , LENGTH = 0xD0000 
    EXTRAHEAP   : ORIGIN = 0x70008000 , LENGTH = 0x21000 
