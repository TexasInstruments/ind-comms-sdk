...
const includes_freertos_r5f_evm = {
    common: [
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_subdevice_demo/device_profiles/402_cia",
...
function getComponentProperty() {
    ...
    property.name = "ethercat_subdevice_cia402_demo";
