...
const libdirs_freertos = {
    common: [
        ...
        "${IND_COMMS_LIBS_PATH}/ethercat_slave",
    ],
};
...
const includes_freertos_r5f_evm = {
    common: [
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_slave_demo/simple",
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_slave_demo/customPhy/inc",
