...
const includes_freertos_r5f_lp = {
    common: [
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_slave_demo/common/board/am261x-lp",
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/examples/industrial_comms/ethercat_slave_demo/common/board/am261x-lp/freertos",
...
const libs_freertos_r5f_lp = {
    common: [
        ...
        "ethercat_slave.am261x_lp.r5f.ti-arm-clang.release.lib",
        "ethercat_slave_bkhf_ssc.am261x_lp.r5f.ti-arm-clang.release.lib",
