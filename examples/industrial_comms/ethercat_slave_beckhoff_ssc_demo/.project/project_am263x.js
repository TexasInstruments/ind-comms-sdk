...
const includes_freertos_r5f = {
    common: [
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/mcu_plus_sdk/source/kernel/freertos/config/am263x/r5f",
...
const libs_freertos_r5f = {
    common: [
        ...
        "ethercat_slave_icss_fwhal.am263x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
