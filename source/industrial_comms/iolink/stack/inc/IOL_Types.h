...
/**
\brief This enumeration indicates changes of communication states to the WDevice
*/
typedef IOL_ENUM_DECL IOLD_EWDeviceMode
{
    IOLD_eWDeviceModeMode_INACTIVE = 0,
    IOLD_eWDeviceModeMode_STARTUP = 1,
    IOLD_eWDeviceModeMode_IDENT_STARTUP = 2,
    IOLD_eWDeviceModeMode_IDENT_CHANGE = 3,
    IOLD_eWDeviceModeMode_PREOPERATE = 4,
    IOLD_eWDeviceModeMode_OPERATE = 5,
}IOLD_EWDeviceMode;
...
#ifdef IOLW_DEVICE_TESTER_UNIT
    IOL_eISDUIndex_WDTU_UplinkTimeShift = 0x50F4,
#endif
}IOL_EISDUIndex;
...
typedef IOL_ENUM_DECL IOL_EErrorType
{
    ...
    */
    ...
    IOL_eErrorType_ARGBLOCK_INCONSISTENT = 0x4002,
    IOL_eErrorType_DEVICE_NOT_ACCESSIBLE = 0x4003,
    IOL_eErrorType_SERVICE_NOT_SUPPORTED = 0x4004,
    IOL_eErrorType_DEVICE_NOT_IN_OPERATE = 0x4005,
    IOL_eErrorType_MEMORY_OVERRUN = 0x4006,
