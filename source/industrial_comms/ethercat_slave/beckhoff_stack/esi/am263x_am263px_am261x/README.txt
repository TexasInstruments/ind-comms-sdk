...
(3) Make sure to use the correct DPRAM size for the corresponding platform.
	- To use the ESI files for AM64x/AM243x, update the DPRAMSize (under <EtherCATController>) from 28672 to 60416.
	- To use the ESI files for AM26x, no change is required.