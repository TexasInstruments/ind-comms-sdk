 ...
 *
 *  \brief
 *  Create diagnosis messge
 *
 *  <!-- Parameters and return values: -->
 *
 *  \param[in]  diagCode_p  Diagnosis code.
 *  \param[in]  type_p      Diagnosis type.
 *  \param[in]  textID_p    Diagnosis text ID.
 *  \param[in]  numParam_p  Number of parameters.
 *  \param[in]  pParam_p    pointer to parameter memory area.
 \return        Result:
                                ...
                                2   : "DIAG_MESSAGE_DISCARD" new message was discard based on Diag History configuration (ack mode and all message slots are filled with not acknowledged messages)
 *
 *  <!-- Group: -->
 *
 *  \ingroup ssc
 *
 * */
uint8_t  SSC_DIAG_newMessage(uint32_t                       diagCode_p
                            ,uint8_t                        type_p
                            ,uint16_t                       textID_p
                            ,uint8_t                        numParam_p
