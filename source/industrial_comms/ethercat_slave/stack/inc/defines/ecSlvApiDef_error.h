...
typedef enum EC_API_EError
{
    ...
    EC_API_eERR_DEPRECATED           = EC_ERROR_CLASS(0x003A),
    EC_API_eERR_PRUFIRMWARE          = EC_ERROR_CLASS(0x003B),
    EC_API_eERR_MDIOFIRMWARE         = EC_ERROR_CLASS(0x003C),
} EC_API_EError_t;
