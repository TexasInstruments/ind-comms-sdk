 ...
 *
 *  \brief
 *  EtherCAT User API ESI interface.
 *
 *  \author
 *  KUNBUS GmbH
 *
...
#if !(defined __ECSLVAPI_ESI_H__)
#define __ECSLVAPI_ESI_H__		1
...
extern ECATSLV_API uint32_t EC_API_SLV_ESI_parseFile(
    EC_API_SLV_SHandle_t* pHandle,
    const char* pFilename);

extern ECATSLV_API uint32_t EC_API_SLV_ESI_parseFileRam(
    EC_API_SLV_SHandle_t* pHandle,
    const uint8_t* pData,
    uint32_t length);
