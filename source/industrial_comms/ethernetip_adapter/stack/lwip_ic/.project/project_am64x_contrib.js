...
const includes = {
    common: [
        ...
        "${INDUSTRIAL_COMMUNICATIONS_SDK_PATH}/source/industrial_comms/ethernetip_adapter/stack/lwip_ic",
...
function getComponentProperty() {
    ...
    property.name = "ethernetip_adapter_lwip-ic-contrib";
    property.tag = "contrib-ic";
